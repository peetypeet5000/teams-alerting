...
exports.postMessage = exports.setup = void 0;
...
async function doPost(message, url) {
    ...
    const res = await (0, axios_1.default)(postMessage);
    return res;
}
/**
 ...
 */
function setup(appName, channels) {
    if (appName.length < 1) {
 ...
 */
async function postMessage(header, sections, channel) {
